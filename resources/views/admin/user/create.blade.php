                                    ...
                                    <div class="card" style="border: none;box-shadow:none;">
                                        ...
                                        <div class="row row-cards">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="cnic" class="form-control @error('cnic') is-invalid @enderror" placeholder="CINC" name="cnic" value="{{old('cnic')}}" required>
                                                @error('cnic')
                                                    <p class="invalid-feedback">{{'*'.$message}}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label required">National Assembly (NA)</label>
                                                <select class="js-basic-single form-control " name="na_constituency_id">
                                                <option disabled selected>--Select</option>
                                                @if ($assemblies)
                                                    ...
                                                    @endforeach
                                                @else
                                                    <option value="">No Assembly Found</option>
                                                @endif
                                                </select>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label required">Provincial Assembly (PA)</label>
                                                <select class="js-basic-single form-control" name="pa_constituency_id">
                                                <option disabled selected>--Select</option>
                                                @if ($assemblies)
                                                    @foreach ($assemblies as $item)
                                                        @if ($item->type == 'PA')
                            ...
                            <div class="col-12">
                                <div class="card-footer">
                                    <div class="btn-list" style="text-align: right;">
                                        ...
                                        <button type="submit" class="btn btn-primary" id="addUser-form-submit">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
